...
int main() {
	...
	//Note that &vertexShaderSource can be used to open a file, good for migrating
	//in final copy https://stackoverflow.com/questions/22100408/what-is-the-meaning-of-the-parameters-to-glshadersource
